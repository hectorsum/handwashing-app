var app = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-7zhrhy");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-7zhrhy");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-snb7by");
    			attr(div, "bp", "grid");
    			button.disabled = /*isRunning*/ ctx[1];
    			attr(button, "class", "start svelte-snb7by");
    		},
    		m(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handwashing.gif" alt="How to wash your hands" class="svelte-ymdsrp"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			h3.innerHTML = `<a href="http://who.int/gpsc/clean_hands_protection/en/">Picture source</a> 
  <a href="https://freesound.org/people/metrostock99/sounds/345086/">Sound source</a>`;
    			...
    			attr(h1, "class", "svelte-1nxep4c");
    			attr(h3, "class", "svelte-1nxep4c");
    		},
    		m(target, anchor) {
